...
contract KAPEX_Fee_Manager is Context, Ownable {
  ...
  uint256 public feeKodaLiquidity = 50; //+ 0.5% sold to BNB, 0.5% sold to KODA
  uint256 public feeKodaKapexLiquidity = 75; //+ KAPEX/KODA pair on SummitSwap

  uint256 public feeKapexLiquidity = 300; //+ 1.5% sold to BNB and paired with KAPEX (PancakeSwap & SummitSwap)

  uint256 public feeStakingPool = 200; //+ Sent to Kapex staking pool
  ...
  address payable public marketingAddress = payable(0x0d4667A202F44D42462712c63050C66fDb25415c);
